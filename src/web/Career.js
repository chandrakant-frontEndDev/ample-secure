...
import bgImg from "../assets/web/Img/Career.png";
import CareerJoin from "../assets/web/Img/CareerImg.png";
import imgone from "../assets/web/Img/Rectangle 71.png";
import imgtwo from "../assets/web/Img/Rectangle 72.png";
import imgthree from "../assets/web/Img/Rectangle 73.png";
import imgfour from "../assets/web/Img/Rectangle 74.png";
import "../assets/web/Styles/Career.css";
    ...
    <>
      <div className="div_Career_container">
        ...
        <div className="Career_headers">
          <h1>Grow Your Career with First Advantage</h1>
        </div>
      </div>
