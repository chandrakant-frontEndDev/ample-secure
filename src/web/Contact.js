...
import bgImg from "../assets/web/Img/Contact.png";
import "../assets/web/Styles/Contact.css";
import Footer from "./Common/Footer";
import G1 from "../assets/web/Img/Vector.png";
import G2 from "../assets/web/Img/Vector (1).png";
import G3 from "../assets/web/Img/Vector (2).png";
import Hand from "../assets/web/Img/Handshake 1.png";
    ...
    <>
      ...
      <div className="div_contact_middle_container">
        <ul className="contact_ul">
          ...
          <li>
            Fox I Vision can help you to cut off from fraudsters who oftentimes
          ...
          <Row className="contact-row">
            ...
            <Col sm="12" md="4" lg="4">
              <div className="Contact_Card">
                ...
                <p>Telephone :- 04723-787934 Mobile :- 9876543210</p>
              </div>
            </Col>
            <Col sm="12" md="4" lg="4">
              <div className="Contact_Card">
      ...
      <div className="form_Contact_with">
        <div className="Contact_heading">
          <h1>Let’s build a secure world together.</h1>
        </div>
