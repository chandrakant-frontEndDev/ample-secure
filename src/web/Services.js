...
import bgImg from "../assets/web/Img/Services.png";
import "../assets/web/Styles/Services.css";
import Footer from "./Common/Footer";
import vectorone from "../assets/web/Img/itservice1.svg";
import vectortwo from "../assets/web/Img/BusinessCase-Normal-02.svg";
import vactorthree from "../assets/web/Img/BFSI-icon-02.svg";
import imgone from "../assets/web/Img/Authlead-300x200.webp";

import vector1 from "../assets/web/Img/fa-solution-icon-application.svg";
import vector2 from "../assets/web/Img/fa-solution-icon-compliant-employees-staff.svg";
import vector3 from "../assets/web/Img/fa-solution-icon-insights.svg";
import vector4 from "../assets/web/Img/fa-solution-icon-compliant.svg";

import imghelp from "../assets/web/Img/360_F_413785526_lRvWq8odEvaNYzPHedW1P98DbLsxusGV.jpg";
    ...
    <>
      <div className="div_Services_container">
        ...
        <div className="Services_headers">
          <h1>Services for Future-Ready Solutions</h1>
          <p>Ample secure provides investigation services in various domains ranging from risk
investigations for insurance industries to personal investigation for individuals.</p>
        </div>
      </div>
      ...
      <div className="div_Service_Profile">
        <div className="div_Profile_title">
          ...
          <p>Profile verification is a critical service that Ample Secure provides to its insurance
...
Ample Secure will work closely with the insurance company to verify the identity,
...
In this, the executive of Ample Secure calls/visits the policy applicant as a stranger
